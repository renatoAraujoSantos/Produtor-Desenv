...
export default function RedefinirSenha({ route, navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.text_header}>Cadastrar Senha!</Text>
            </View>
            <Animatable.View
            ...
            >
                <ScrollView>
                    ...
                    <View style={styles.textPrivate}>
                        ...
                        <Text style={[styles.color_textPrivate, { fontWeight: 'bold' }]}>{" "}Preencha os campos para criar nova senha</Text>
                    </View>
